...
export const POS: React.FC = () => {
  ...
  return (
    <div className="flex h-[calc(100vh-2rem)] md:h-screen overflow-hidden bg-gray-50 md:-m-8">
      
      {/* LEFT COLUMN: PRODUCT LIST (DESKTOP) */}
      <div className="flex-1 hidden md:flex flex-col border-r border-gray-200">
      ...
      <div className="w-full md:w-[420px] bg-white flex flex-col h-full shadow-2xl z-20">
        ...
        <div className="md:hidden p-4 bg-white border-b shadow-sm z-10">
          <div className="flex justify-between items-center mb-3">
             <div className="font-bold text-gray-800 text-lg">Kasir</div>
          ...
          <div className="flex gap-2">
            <button onClick={() => setIsScannerOpen(true)} className="flex-1 bg-gray-900 text-white py-2.5 rounded-xl flex justify-center items-center gap-2 font-bold shadow-lg"><Scan size={18}/> Scan</button>
        ...
        <div className="hidden md:flex p-5 border-b items-center justify-between bg-white">
        ...
        <div className="p-5 bg-white border-t border-gray-100 shadow-[0_-10px_40px_rgba(0,0,0,0.05)] z-20">
          ...
          <div className="flex gap-3">
            <button 
              ...
              className="px-5 py-4 rounded-xl font-bold text-gray-600 bg-gray-100 hover:bg-gray-200 transition-all flex flex-col items-center justify-center disabled:opacity-50 disabled:cursor-not-allowed"
            ...
            <button 
              ...
              disabled={cart.length === 0}
              className={`flex-1 py-4 px-6 rounded-xl font-bold text-lg shadow-xl flex items-center justify-center gap-3 transition-all active:scale-95 disabled:opacity-50 disabled:shadow-none disabled:transform-none disabled:cursor-not-allowed ${
